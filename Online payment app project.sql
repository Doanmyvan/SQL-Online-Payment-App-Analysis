...
/* 4. Compute the monthly total amount of customer transactions in 2018 and its percentage contribution to the annual total. */
...
/* 5.Identify product group received the highest total payment from customers in 2018. */
...
/* 6. Determine top 3 payment method was used most frequently in 2018 based on the number of transactions */
...
/* 7. Calculate the monthly total number of failed transaction, and the failed rate relative to the total monthly transactions in 2018*/
...
/* 8. Measure growth in success transaction number in 2018 relative to the same period in 2017. */
With table_month AS (
...
/* 9. List of new users in 2018 (who were not active in 2017). */
...
/* 10. Customer retention rate broken down by month in 2018. */
With table_first As (
        Select customer_id
        , order_id
        , transaction_date
